...
class Ui_Login(QtGui.QDialog):
    ...
    def retranslateUi(self, Login_Dialog):
        Login_Dialog.setWindowTitle(_translate("Login_Dialog", "YAPDNS User Login", None))
    ...
    def Login_btn(self):
        ...
        if not username:
            QtGui.QMessageBox.warning(self, 'Username Missing!', 'Please fill a username')
        elif not password:
            QtGui.QMessageBox.warning(self, 'Password Missing!', 'Please fill a password')
        else:
        ...
        for col in t:
            if username == col[1]:
                if password == col[2]:
                    ...
                    QtGui.QMessageBox.warning(self, 'Password incorrect', 'Try again')
                    return
...
class Ui_Register(QtGui.QDialog):
    ...
    def Add_btn(self):
        ...
        if not username:
            ...
            QtGui.QMessageBox.warning(self, 'Try again', 'Passwords do not match')
            ...
            for col in t:
                if username == col[1]:
                    QtGui.QMessageBox.warning(self, 'Try again', 'Username taken')
            else:
                self.dbu.AddEntryToTable(username, password)
                QtGui.QMessageBox.information(self, 'Welcome', 'User added successfully')
                self.close()
